          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <select
                ...
                className="w-48 px-3 py-3 text-gray-800 transition-all duration-200 bg-white border border-gray-300 appearance-none cursor-pointer font-madrid focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-red-600"
                style={{
